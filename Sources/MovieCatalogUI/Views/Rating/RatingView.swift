...
//  
//
//  Created by Rifqi Fadhlillah on 11/02/21.
//
...
public struct RatingView: View {
	...
	public init(_ rating: Binding<Double>, maxRating: Int = 5) {
		_rating = rating
	...
	private func rating(at position: CGPoint) -> Double {
		...
		let starPercent = x.truncatingRemainder(dividingBy: starWithSpaceWidth) / Double(singlePaddingWidth) * 100
...
struct RatingView_Previews: PreviewProvider {
	@State static var rating: Double = 4
